...
<body>
	...
	<div class="container">
  <!-- Brand -->
  <a class="navbar-brand" href="#"><span>TPT</span> Software</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a class="nav-link" href="user/view/createsubject.php">Đăng ký môn học</a>
      </li>
	   <!-- Dropdown -->
    <?php 
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        ...
        <a class="dropdown-item" href="user/model/logout.php">Đăng xuất</a>
      </div>
    </li>
    <?php 
      }else{
...
<div class="banner">
	...
	<button type="button" class="btn btn-warning text-dark btn-banner">Bắt đầu</button>
	</div>
	</div>
</div>
<section id="about">
