...
<div class="login">
  	<div class="wrap">
		...
		<div class="login-title">
       		<h4 class="title">Điền Email Của Bạn</h4>
			<div id="loginbox" class="loginbox">
				<form method="POST" action="#" name="login" id="login-form">
				  <fieldset class="input">
				    ...
				    <?php
                    if(isset($_SESSION['error_khongtontai'])){
                        echo "<div class='alert alert-danger'>".$_SESSION['error_khongtontai']."</div>";

                    } 
                	?>
				    <div class="remember">
					    
					    <input type="submit" name="laylaimatkhau" class="button" value="Lấy Lại Mật Khẩu"><div class="clear"></div>
					 </div>
				  </fieldset>
				 </form>
			</div>
