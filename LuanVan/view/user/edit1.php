	...
	<form method="POST" enctype="multipart/form-data">
		<div class="thongtincb">
			...
			<div class="d_thongtincb">
				...
				<select id="bonhotrong" name="bonhotrong">
					<option value=":<?=$nhotrong?>"><?=$nhotrong?></option>
			...
			<div class="d_thongtincb">
				...
				<select id="khecamsim" name="khecamsim">
					<option value=":<?=$khesim?>"><?=$khesim?></option>
			...
			<div class="d_thongtincb">
				...
				<select id="chongthamnuoc" name="chongthamnuoc">
					<option value=":<?=$chongnuoc?>"><?=$chongnuoc?></option>
			...
			<div class="d_thongtincb">
				...
				<select id="manhinh" name="manhinh">
					<option value=":<?=$kichthuocmanhinh?>"><?=$kichthuocmanhinh?></option>
			...
			<div class="d_thongtincb">
				...
				<select id="hedieuhanh" name="hedieuhanh">
					<option value=":<?=$hedieuhanh?>"><?=$hedieuhanh?></option>
					<option value=":No">No</option>
			...
			<div class="d_thongtincb">
				...
				<select id="camsau" name="camsau">
					<option value=":<?=$camsau?>"><?=$camsau?></option>
			...
			<div class="d_thongtincb">
				...
				<select id="camtruoc" name="camtruoc">
					<option value=":<?=$camtruoc?>"><?=$camtruoc?></option>
			...
			<div class="d_thongtincb">
				...
				<select id="microUSB" name="microUSB">
			...
			<div class="d_thongtincb">
				...
				<textarea name="mota" required><?=$chitietsanpham->MoTa?></textarea>
			</div>
			<div class="d_thongtincb">
