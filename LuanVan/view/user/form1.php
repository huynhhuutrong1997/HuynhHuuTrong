	...
	<form method="POST" enctype="multipart/form-data">
		<div class="thongtincb">
			...
			<div class="d_thongtincb">
				...
				<select id="model" name="model1" required>
					<option value=""></option>
			...
			<div class="d_thongtincb">
				...
				<select id="bonhotrong" name="bonhotrong" required>
					<option value=""></option>
			...
			<div class="d_thongtincb">
				...
				<select id="mang" name="mang" required>
					...
					<option value=":CDMA/EVDO">CDMA/EVDO</option>
				</select>
			</div>
			<div class="d_thongtincb">
				<label class="label_thongtincb">Khe cắm sim:</label>
				<select id="khecamsim" name="khecamsim" required>
					<option value=""></option>
					<option value=""></option>
			...
			<div class="d_thongtincb">
				...
				<select id="chongthamnuoc" name="chongthamnuoc" required>
					<option value=""></option>
					<option value=""></option>
			...
			<div class="d_thongtincb">
				...
				<select id="manhinh" name="manhinh" required>
					<option value=""></option>
			...
			<div class="d_thongtincb">
				...
				<select id="hedieuhanh" name="hedieuhanh" required>
					<option value=""></option>
					<option value=":No">No</option>
					...
					<option value=":Android 4.3.1">Android 4.3.1</option>
					...
					<option value=":Android 7.1.2">Android 7.0.2</option>
					<option value=":Android 8.0">Android 8.0</option>
					<option value=":Android 8.1">Android 8.1</option>
					<option value=":IOS 1">IOS 1</option>
					<option value=":IOS 2">IOS 2</option>
			...
			<div class="d_thongtincb">
				...
				<select id="camsau" name="camsau" required>
					<option value=""></option>
			...
			<div class="d_thongtincb">
				...
				<select id="camtruoc" name="camtruoc" required>
					<option value=""></option>
			...
			<div class="d_thongtincb">
				...
				<select id="blutoo" name="blutoo" required>
					<option value=""></option>
					<option value=":Yes">Yes</option>
					<option value=":No">No</option>
			...
			<div class="d_thongtincb">
				...
				<select id="microUSB" name="microUSB" required>
					<option value=""></option>
			...
			<div class="d_thongtincb">
				...
				<select id="mau" name="mau" required>
					<option value=""></option>
			...
			<div class="d_thongtincb">
				...
				<select id="baohanh" name="baohanh" required>
					<option value=""></option>
			...
			<div class="d_thongtincb">
				<label class="label_thongtincb">Giá:</label><input type="number" name="gia" min="0" required>
				
			</div>
			<div class="d_thongtincb">
				<label class="label_thongtincb">Kho hàng:</label><input type="number" name="khohang" min="1" required>
		...
		<div class="btn_them">
			...
			<div class="quaylai"><a type="button" href="c_themsanpham.php?action=danhmuc">Quay Lại</a></div>
		</div>
	</form>
</div>
