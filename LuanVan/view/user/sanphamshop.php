...
<body>
	<div class="shop_head">
		...
		<div class="shop_menu">
			<ul>
				...
				<li ><a class="active" href="c_shop.php?action=sanpham&shop=<?=$id_user?>">Tất Cả Sản Phẩm</a></li>
	...
	<!-- <div class="shop_banner_big">
		<img src="../public/images/background/banner.png">
	</div> -->
	<div class="shop_content">
		  <h2 class="head">Tất Cả Sản Phẩm</h2>
		  <div class="top-box">
		  	<?php 
