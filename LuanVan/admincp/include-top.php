...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="c_index.php">Admin TKShop</a>
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="alertsDropdown">
                <a class="dropdown-item" href="c_admin.php?action=chuaxacnhan">Đơn Hàng</a>
                <a class="dropdown-item" href="c_admin.php?action=binhluan">Bình Luận</a>
      ...
      <!--   <li class="nav-item dropdown no-arrow mx-1">
        ...
        <li class="nav-item dropdown no-arrow user">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                <i class="fas fa-user"></i>    <?php if(isset($_SESSION['userName'])){echo $_SESSION['userName'];}else{header('location:login.php');} ?><b class="caret"></b>
            </a>
            <ul class="dropdown-menu dropdown-user">
                <li class="icon-dropdown"><a href="#"><i class="fas fa-user"></i> User Profile</a>
                </li>
                <li class="divider"></li>
                <li class="icon-dropdown"><a href="c_admin.php?action=logout"><i class="fas fa-sign-out-alt"></i> Đăng Xuất</a>
                </li>
            </ul>
        </li>
    </ul>
